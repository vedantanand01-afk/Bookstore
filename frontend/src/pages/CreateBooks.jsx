...
const CreateBooks = () => {
  ...
  const [description, setDescription] = useState('A beautiful bookstore entry.');
  const [coverImage, setCoverImage] = useState('https://images.unsplash.com/photo-1512820790803-83ca734da794?auto=format&fit=crop&w=900&q=80');
  ...
  const handleSaveBook = async () => {
    ...
    try {
      ...
      alert('Unable to save the book. Please check the form and try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className='space-y-6 p-4'>
      ...
      <div className='rounded-[28px] border border-slate-200 bg-white p-6 shadow-lg'>
        <h1 className='text-3xl font-semibold text-slate-900'>Create a New Book</h1>
        <p className='mt-2 text-slate-600'>Add polished book metadata for the bookstore listing.</p>
